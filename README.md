...
江西省体育运动学校管理系统（基于Jeecg-Boot 快速开发平台（前后端分离版本））
===============

当前最新版本： jeecg-boot版本：2.1.1（发布日期：20191213）

项目介绍：
-----------------------------------

<h3 align="center">江西省体育运动学校管理系统</h3>

江西省体育运动学校是基于jeecg-boot的开源版本构建而成，关于[Jeecg-Boot快速开发平台开源项目](https://gitee.com/jeecg/jeecg-boot)请参考相关项目或者项目的分支
