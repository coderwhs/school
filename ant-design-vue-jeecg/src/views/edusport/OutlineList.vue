  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="大纲名称">
              <a-input placeholder="请输入大纲名称" v-model="queryParam.outlineName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="大纲组别">
              <a-input placeholder="请输入大纲组别" v-model="queryParam.groupId"></a-input>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('tb_edu_outline')">导出</a-button>
    ...
    <outline-modal ref="modalForm" @ok="modalFormOk"></outline-modal>
  </a-card>
</template>
...
<script>
  ...
  import OutlineModal from './modules/OutlineModal'
  ...
  export default {
    ...
    data () {
      return {
        description: 'tb_edu_outline管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/edusport/outline/list",
          delete: "/edusport/outline/delete",
          deleteBatch: "/edusport/outline/deleteBatch",
          exportXlsUrl: "/edusport/outline/exportXls",
          importExcelUrl: "edusport/outline/importExcel",
        },
        dictOptions:{
         athleteNos:[],
         eventCodes:[],
