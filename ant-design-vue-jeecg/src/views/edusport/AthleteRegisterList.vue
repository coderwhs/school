  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="6" :sm="8"><!--            控制页面头部的表单-->
            <a-form-item label="注册人姓名">
              <j-search-select-tag
                placeholder="请输入注册人姓名"
                dict="tb_edu_athlete,athlete_name,process_id"
                :async="true">
              </j-search-select-tag>
            </a-form-item>
          </a-col>
...
<!--      <a-button @click="handleAdd" type="primary" icon="plus">我要请假</a-button>-->
    ...
    <athleteRegister-modal ref="modalForm" @ok="modalFormOk"></athleteRegister-modal>
  </a-card>
</template>
<script>
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
  import AthleteRegisterModal from './modules/AthleteRegisterModal_Style#Drawer'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/athleteRegister/taskList",
          add: "/athleteRegister/add",
          delete: "/athleteRegister/delete",
          deleteBatch: "/athleteRegister/deleteBatch",
          exportXlsUrl: "/athleteRegister/exportXls",
          importExcelUrl: "/athleteRegister/importExcel",
        },
