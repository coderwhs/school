  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="指标类别编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'indexCatNo', validatorRules.indexCatNo]" placeholder="请输入指标类别编码"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
        indexCatNo:{rules: [{ required: true, message: '请输入指标类别编码!' }]},
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'indexCatNo','indexCatName'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'indexCatNo','indexCatName'))
      },
