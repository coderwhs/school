<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!--<a-button type="primary" icon="download" @click="handleExportXls('宿舍运动员入住表')">导出</a-button>
    ...
    <dormAthleteLiving-modal ref="modalForm" @ok="modalFormOk"></dormAthleteLiving-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/edusport/dormAthleteLiving/list",
          delete: "/edusport/dormAthleteLiving/delete",
          deleteBatch: "/edusport/dormAthleteLiving/deleteBatch",
          exportXlsUrl: "/edusport/dormAthleteLiving/exportXls",
          importExcelUrl: "edusport/dormAthleteLiving/importExcel",
        },
        dictOptions:{
        },
      }
    ...
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加运动员信息";
      },
