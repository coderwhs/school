<template>
  <a-card :bordered="false">
    ...
    <athleteSelectionTestCoach-modal ref="modalForm" @ok="modalFormOk"></athleteSelectionTestCoach-modal>
  </a-card>
</template>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'测试运动员',
            align:"center",
            dataIndex: 'athleteIds',
            customRender:(text)=>{
              if(!text){
                return ''
              }else{
                return filterMultiDictText(this.dictOptions['athleteIds'], text+"")
              }
            }
          },
          {
        ...
        url: {
          ...
          deleteBatch: "/edusport/athleteSelectionTestCoach/deleteBatch",
    ...
    methods: {
      initDictConfig(){
        ...
        initDictOptions('tb_edu_sport_event,event_name,event_code').then((res) => {
          if (res.success) {
