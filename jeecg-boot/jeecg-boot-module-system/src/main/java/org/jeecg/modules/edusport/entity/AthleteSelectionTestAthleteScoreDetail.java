 ...
 */
@Data
@TableName("tb_edu_athlete_selection_test_athlete_score_detail AS t")
public class AthleteSelectionTestAthleteScoreDetail implements Serializable {
	...
	/**测试成绩id*/
	@Excel(name = "测试成绩id", width = 15)
    private java.lang.String athleteScoreId;
	/**所属组别*/
    ...
    private java.lang.Integer testScore;
	/**测试等级评定*/
