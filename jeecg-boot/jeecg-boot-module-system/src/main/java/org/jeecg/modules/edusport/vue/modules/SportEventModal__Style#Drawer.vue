  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="大项代码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'sportCode', validatorRules.sportCode]" placeholder="请输入大项代码"></a-input>
        </a-form-item>
        <a-form-item label="分项代码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['disciplinesCode']" :trigger-change="true" dictCode="" placeholder="请选择分项代码"/>
        </a-form-item>
        ...
        <a-form-item label="启用状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="radio" v-decorator="['enableStatus']" :trigger-change="true" dictCode="" placeholder="请选择启用状态"/>
        </a-form-item>
