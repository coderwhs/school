...
import org.jeecg.modules.edusport.entity.Teacher;
import org.jeecg.modules.edusport.service.ITeacherService;
 ...
 */
@RestController
@RequestMapping("/edusport/teacher")
@Slf4j
public class TeacherController extends JeecgController<Teacher, ITeacherService> {
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Teacher teacher) {
        return super.exportXls(request, teacher, Teacher.class, "教练员信息");
    }
