  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sportClassId','studentNo','attendDate','athleteBestScore','athleteAwardTechGrade','aboutBreakRecord','remark'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'sportClassId','studentNo','attendDate','athleteBestScore','athleteAwardTechGrade','aboutBreakRecord','remark'))
      },
